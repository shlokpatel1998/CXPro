...
from contexts.identity_access.invitations import send_invite, can_manage_team, is_valid_role
...
class TestInvitesEndpoint(unittest.TestCase):
    ...
    def test_cm_can_invite(self):
        ...
        async def run_test():
            ...
            # Verify invitation was created (2 calls: insert + notify for outbox event)
